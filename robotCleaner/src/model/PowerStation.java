...
/*    Name of class:          PowerStation.java
...
public final class PowerStation extends TileImpl{
	...
	PowerStation(String coordinate){
	    super(coordinate);  //call the super class
	    //Initialize the variable
		_identifier = Para.INSTANCE.getPowerStationID();
		_cost = (double)Para.INSTANCE.getLowPileID();
